<nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <img class="mb-4" <?php echo $ruta = basename($_SERVER['PHP_SELF']) == 'homeAdmin.php' ? 'src="img/logo.png"' : 'src="../img/logo.png"'; ?> alt="" width="170">    
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" <?php echo $ruta = basename($_SERVER['PHP_SELF']) == 'homeAdmin.php' ? 'href="homeAdmin.php"' : 'href="../homeAdmin.php"'; ?>>Inicio</a>
                </li>
